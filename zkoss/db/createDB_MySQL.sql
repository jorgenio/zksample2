/*==============================================================*/
/* DBMS name:      MySQL 5.1.45 community edition               */
/* Created on:     22.04.2009 13:07                             */
/* Changed on:     17.08.2010 12:00                             */
/*==============================================================*/


drop table if exists test_db.filiale cascade;
drop table if exists test_db.kunde cascade;
drop table if exists test_db.artikel cascade;
drop table if exists test_db.auftrag cascade;
drop table if exists test_db.auftragposition cascade;
drop table if exists test_db.branche cascade;

drop table if exists test_db.sec_user cascade;
drop table if exists test_db.sec_userrole cascade;
drop table if exists test_db.sec_role cascade;
drop table if exists test_db.sec_rolegroup cascade;
drop table if exists test_db.sec_group cascade;
drop table if exists test_db.sec_groupright cascade;
drop table if exists test_db.sec_right cascade;

drop table if exists test_db.sec_loginlog cascade;
drop table if exists test_db.log_ip2country cascade;
drop table if exists test_db.guestbook cascade;
drop table if exists test_db.ipc_ip2country cascade;
 
drop table if exists test_db.hibernate_entity_statistics cascade;
drop table if exists test_db.hibernate_statistics cascade;
...
CREATE FUNCTION 'test_db.get_nextid'
RETURNS INT
BEGIN
DECLARE nextid INT;
...
create table ipc_ip2country (
   ...
   ipc_ip_from          bigint                 null,
   ipc_ip_to            bigint                 null,
...
create table sys_ip4country (
   i4co_id              bigint                 not null,
   i4co_ip              bigint                 null,
   i4co_ccd_id          bigint                 null,
   version              int                 null default 0,
   primary key (i4co_id)
);
