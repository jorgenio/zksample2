...
public class CustomerDialogCtrl extends GFCBaseCtrl implements Serializable {
	...
	public void onCreate$window_customerDialog(Event event) throws Exception {
		...
		btnCtrl = new ButtonStatusCtrl(getUserWorkspace(), btnCtroller_ClassPrefix, null, null, null, null, null, null, btnNew, btnEdit, btnDelete, btnSave, btnCancel, btnClose);
